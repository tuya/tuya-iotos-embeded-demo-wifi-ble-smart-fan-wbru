 ...
 * @LastEditTime: 2021-07-28 14:10:00
 */
 ...
 */
STATIC OPERATE_RET _soc_flash_file_write(IN CHAR_T *file_name, IN UCHAR_T *data, IN USHORT_T len)
{
    OPERATE_RET ret = -1;
    uFILE * fp = NULL;
    UINT_T off_set = 0;
 ...
 * @return: OPERATE_RET 0表示成功，非0请参照tuya error code描述文档 
 */
OPERATE_RET tuya_soc_flash_write(IN SOC_FLASH_SAVE_TYPE_E data_type, IN UINT_T addr, IN UCHAR_T *data, IN USHORT_T len)
{
    OPERATE_RET ret = -1;
    CHAR_T temp[4] = {0};
 ...
 * @return: OPERATE_RET 0表示成功，非0请参照tuya error code描述文档
 */
OPERATE_RET tuya_soc_cfg_write(IN USHORT_T len, IN UCHAR_T *data)
{
    OPERATE_RET ret = -1;
    uFILE * fp = NULL;
    UINT_T write_cnt = 0;
 ...
 * @return: OPERATE_RET 0表示成功，非0请参照tuya error code描述文档
 */
OPERATE_RET tuya_soc_cfg_read(OUT USHORT_T *len, OUT UCHAR_T *data)
{
    OPERATE_RET ret = -1;
    uFILE * fp = NULL;
    UINT_T read_cnt = 0;
 ...
 * @return: OPERATE_RET 0表示成功，非0请参照tuya error code描述文档
 */
OPERATE_RET tuya_soc_flash_earse_special(IN SOC_FLASH_SAVE_TYPE_E data_type, IN UINT_T addr)
{
    OPERATE_RET ret = 0;
    CHAR_T temp[4] = {0};
 ...
 * @return: OPERATE_RET 0表示成功，非0请参照tuya error code描述文档
 */
OPERATE_RET tuya_soc_flash_earse(VOID)
{
    OPERATE_RET ret = -1;
    UCHAR_T i = 0;
